...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="usn" name="usn" placeholder="Enter your usn (Ex.732116104***)" class="form-control input-md" type="text" value="<?php
if (isset($_GET['usn']))
{
echo $_GET['usn'];
}?>">
...
<div class="col-md-3 box">
<span href="#" data-target="#login" style="color:lightyellow">Organized by JIT<br><br></span>
</div>
